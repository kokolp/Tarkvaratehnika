...
define('kalkulaator',['exports', './line'], function (exports, _line) {
	...
	var Kalkulaator = exports.Kalkulaator = function () {
		...
		Kalkulaator.prototype.addLine = function addLine() {
			var line = new _line.Line(this.name, parseFloat(this.expectedSum), parseFloat(this.actualSum), this.type);
...
define('line',["exports"], function (exports) {
	...
	var Line = exports.Line = function Line(name, expectedSum, actualSum, type) {
